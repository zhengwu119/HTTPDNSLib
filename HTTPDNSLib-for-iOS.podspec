...
Pod::Spec.new do |s|
  ...
  s.name         = "HTTPDNSLib"
  s.version      = "0.0.1"
  s.summary      = "HttpDNS lib库 iOS版本 改良版。"
  ...
  s.homepage     = "https://github.com/zhengwu119/HTTPDNSLib"
  ...
  s.author             = { "zhengwu119" => "zhengwu119@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/zhengwu119/HTTPDNSLib.git", :commit => "6b44a69370a27b00bc905ba998e91ffb7028dca9" }
